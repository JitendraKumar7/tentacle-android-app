...
public class GetPendingCall extends AsyncTask<Void, Void, String> {
	...
	protected String doInBackground(Void... arg0) {
		try {
			...
			if (!PreferenceUtil.getSharedPreferences(context, PreferenceUtil.PINID, "").isEmpty()) {
                ...
                keyValuePairs.put("token", PreferenceUtil.getSharedPreferences(context, PreferenceUtil.AUTHTOKEN, ""));
                keyValuePairs.put("pin", PreferenceUtil.getSharedPreferences(context, PreferenceUtil.PINID, ""));
