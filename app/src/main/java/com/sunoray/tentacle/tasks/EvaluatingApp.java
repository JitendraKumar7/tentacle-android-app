...
public class EvaluatingApp extends AsyncTask<String, Void, Boolean> {
		private static final Logger log = LoggerFactory.getLogger(EvaluatingApp.class);
		private Context context;
		private TextView txt;
		private TextView txtError;				
		
		public EvaluatingApp(Context context, TextView txt, TextView txtError) {
		...
		protected Boolean doInBackground(String... params) {
			...
			Thread.currentThread().setName("EvaluatingAppAsyncTask");
