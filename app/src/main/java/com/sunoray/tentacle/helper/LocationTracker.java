    ...
    public boolean getLocation() {
        try {
            ...
            if (isGPSEnabled == false && isNetworkEnabled == false) {
            	if(PreferenceUtil.getSharedPreferences(context, PreferenceUtil.userRole, "field_exec").equalsIgnoreCase("field_exec")){
            		showLocationSettingsAlert(context);
            	} else if(PreferenceUtil.getSharedPreferences(context, PreferenceUtil.locationAlert, "show").equalsIgnoreCase("show")){
            		showLocationSettingsAlert(context);
            		PreferenceUtil.setSharedPreferences(context, PreferenceUtil.locationAlert, "seen");
            	}
            	return false;
            } else {
