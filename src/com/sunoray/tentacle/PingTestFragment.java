...
public class PingTestFragment extends DialogFragment {
	...
	private boolean checkInternetConnection() {
		...
		try {
			...
			if(taskStatus){
				txtInternetConnectionStatus.setTextColor(getResources().getColor(R.color.tentacle_green));
	...
	private void startLocationService() {
		try {
			if(PreferanceUtil.getSharedPreferences(getActivity().getApplicationContext(), PreferanceUtil.userRole, "").equals("field_exec")) {
